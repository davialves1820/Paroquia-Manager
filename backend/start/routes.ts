  ...
  .group(() => {
    ...
    router
      .group(() => {
        ...
        router
          .delete('/:id', [MemberController, 'destroy'])
          .use(middleware.rbac({ roles: ['ADMIN'] }))
      })
      .prefix('members')
    ...
    router
      .group(() => {
        ...
        router
          .post('/', [SacramentController, 'store'])
          .use(middleware.rbac({ roles: ['ADMIN', 'PADRE'] }))
        router
          .put('/:id', [SacramentController, 'update'])
          .use(middleware.rbac({ roles: ['ADMIN', 'PADRE'] }))
        router
          .delete('/:id', [SacramentController, 'destroy'])
          .use(middleware.rbac({ roles: ['ADMIN', 'PADRE'] }))
      })
      .prefix('sacraments')
    ...
    router
      .group(() => {
        ...
        router.get('classes/:classId/students/:studentId/frequency', [
          CatechismController,
          'frequency',
        ])
      ...
      .prefix('catechism')
      .use(middleware.rbac({ roles: ['ADMIN', 'CATEQUISTA'] }))
